...
$routes->add(
    'product_desc_list',
    new Route('/product/desclist', ['_controller' => [ProductController::class, 'descListAction']])
);
$routes->add(
    'product_info',
...
$routes->add(
    'user_list',
    new Route('/user/list', ['_controller' => [\Controller\UserController::class, 'listAction']])
);
